  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200 via-white to-green-200 px-4">
      <motion.form
        ...
        className="w-full max-w-md bg-white/30 backdrop-blur-md p-10 rounded-3xl shadow-2xl border border-white/40"
      >
        {/* Header */}
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-600">Sign up to get started with NestFinder</p>
        </div>
        ...
        <input
          ...
          value={form.name}
          onChange={handleChange}
          className="w-full px-4 py-3 border border-blue-300 rounded-xl text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4"
          required
        />
        <input
          type="email"
        ...
        <select
          ...
          value={form.role}
          onChange={handleChange}
          className="w-full px-4 py-3 border border-blue-300 rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4 bg-white"
        >
          <option value="buyer">Buyer</option>
          <option value="seller">Seller</option>
          <option value="agent">Agent</option>
        ...
        {message && (
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-green-600 text-center font-semibold mt-4 bg-green-100 py-2 rounded-lg"
          >
            {message}
          </motion.p>
        )}
        {error && (
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-red-600 text-center font-semibold mt-4 bg-red-100 py-2 rounded-lg"
          >
            {error}
          </motion.p>
        )}
